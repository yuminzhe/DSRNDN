...
def test():
    # restore graph
    input_1d = tf.placeholder("float", shape=[None, None, 1310], name="input_x1")
    input_2d = tf.placeholder("float", shape=[None, None, None, 443], name="input_x2")
